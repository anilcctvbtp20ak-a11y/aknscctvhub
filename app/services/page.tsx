...
<button className="bg-primary text-on-primary font-bold py-3 px-8 rounded-lg hover:bg-surface-tint transition-colors">Contact Sales</button>
<button className="bg-transparent border-2 border-white text-white font-bold py-3 px-8 rounded-lg hover:bg-white hover:text-[#e63946] transition-colors">View Products</button>
</div>
</div>
</section>
</main>
